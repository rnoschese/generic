...
$routes->get('/reset_password', 'Auth::reset_password');
...
//$routes->get('/members', 'Members::index',['filter' => 'auth']);
//$routes->get('/impostazione-permessi/(:hash)', 'Members::impostazione_permessi',['filter' => 'auth']);
